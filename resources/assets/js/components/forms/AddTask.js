                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
                    ...
                    <ModalBody>
                        <FormGroup>
                            ...
                            <Input className={this.hasErrorFor('title') ? 'is-invalid' : ''} type="text" name="title" id="taskTitle" onChange={this.handleInput.bind(this)}/>
                            {this.renderErrorFor('title')}
                        </FormGroup>
                        
                        <FormGroup>
                            <Label for="content">Task Details:</Label>
                            <Input className={this.hasErrorFor('content') ? 'is-invalid' : ''} type="textarea" name="content" id="content" onChange={this.handleInput.bind(this)}/>
                            {this.renderErrorFor('content')}
                        </FormGroup>

                        <FormGroup>
                            <Label for="contributors">Assign to:</Label>
                            <Input className={this.hasErrorFor('contributors') ? 'is-invalid' : ''} type="select" name="contributors" id="contributors" onChange={this.handleInput.bind(this)}>
                        ...
                        <FormGroup>
                            ...
                            <Input className={this.hasErrorFor('task_color') ? 'is-invalid' : ''} type="select" name="task_color" id="task_color" onChange={this.handleInput.bind(this)}>
                                <option value="">Choose:</option>
                        ...
                        <Input className={this.hasErrorFor('due_date') ? 'is-invalid' : ''} type="datetime-local" name="due_date" id="due_date" onChange={this.handleInput.bind(this)}/>

                ...
                <Modal isOpen={this.state.modal} toggle={this.toggle} className={this.props.className}>
                    ...
                    <ModalBody>
                        <FormGroup>
                            ...
                            <Input className={this.hasErrorFor('name') ? 'is-invalid' : ''} type="text" name="name" id="name" placeholder="Name" onChange={this.handleInput.bind(this)} />
                        ...
                        <FormGroup>
                            ...
                            <Input className={this.hasErrorFor('cover') ? 'is-invalid' : ''} type="file" name="cover" id="cover" onChange={this.handleInput.bind(this)}/>

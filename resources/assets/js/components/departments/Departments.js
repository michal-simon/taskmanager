            ...
            return this.state.departments.map(department => {
                ...
                return <tr key={department.id}>
                    ...
                    <td>
                        ...
                        <EditDepartment department={department} departments={this.state.departments} action={this.addUserToState}/>
                    </td>
                </tr>
            })
        } else {
    ...
    render () {
        ...
        return (
            <div className="data-table m-md-3 m-0">
                ...
                <AddDepartment departments={this.state.departments} action={this.addUserToState}/>
